...
@DebugMetadata(
   ...
   m = "invokeSuspend",
   c = "com.example.PlannerViewModel$special$$inlined$flatMapLatest$2"
)
@Metadata(
   mv = {2, 2, 0},
   k = 3,
...
public final class PlannerViewModel$special$$inlined$flatMapLatest$2 extends SuspendLambda implements Function3 {
   int label;
   // $FF: synthetic field
   private Object L$0;
   // $FF: synthetic field
   ...
   public PlannerViewModel$special$$inlined$flatMapLatest$2(Continuation $completion, PlannerViewModel var2) {
      super(3, $completion);
      this.this$0 = var2;
   }
   ...
   public final Object invokeSuspend(Object $result) {
      ...
      switch (this.label) {
         case 0:
            ...
            int var9 = 0;
            Flow var10001 = PlannerViewModel.access$getNoteDao$p(this.this$0).getNotesForDate(this.this$0.getCurrentUserId(), PlannerViewModel.access$getStartOfDay(this.this$0, var7), PlannerViewModel.access$getEndOfDay(this.this$0, var7));
   ...
   public final Object invoke(FlowCollector p1, Object p2, Continuation p3) {
      PlannerViewModel$special$$inlined$flatMapLatest$2 var4 = new PlannerViewModel$special$$inlined$flatMapLatest$2(p3, this.this$0);
      var4.L$0 = p1;
      var4.L$1 = p2;
