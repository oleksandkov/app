...
public final class PlannerViewModel$special$$inlined$map$1$2 implements FlowCollector {
   // $FF: synthetic field
   final FlowCollector $this_unsafeFlow;

   public PlannerViewModel$special$$inlined$map$1$2(FlowCollector $receiver) {
   ...
   public final Object emit(Object value, Continuation $completion) {
      ...
      label36: {
         if ($completion instanceof PlannerViewModel$special$$inlined$map$1$2$1) {
            $continuation = (PlannerViewModel$special$$inlined$map$1$2$1)$completion;
         ...
         $continuation = new PlannerViewModel$special$$inlined$map$1$2$1(this, $completion);
      }
      ...
      switch ($continuation.label) {
         ...
         case 1:
            ...
            Continuation $completion = (PlannerViewModel$special$$inlined$map$1$2$1)$continuation.L$1;
