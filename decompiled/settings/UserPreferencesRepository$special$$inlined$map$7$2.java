...
public final class UserPreferencesRepository$special$$inlined$map$7$2 implements FlowCollector {
   // $FF: synthetic field
   final FlowCollector $this_unsafeFlow;

   public UserPreferencesRepository$special$$inlined$map$7$2(FlowCollector $receiver) {
   ...
   public final Object emit(Object value, Continuation $completion) {
      ...
      label25: {
         if ($completion instanceof UserPreferencesRepository$special$$inlined$map$7$2$1) {
            $continuation = (UserPreferencesRepository$special$$inlined$map$7$2$1)$completion;
         ...
         $continuation = new UserPreferencesRepository$special$$inlined$map$7$2$1(this, $completion);
      }
      ...
      switch ($continuation.label) {
         case 0:
            ...
            int var13 = 0;
            Boolean var10000 = (Boolean)var12.get(UserPreferencesRepository.PreferencesKeys.INSTANCE.getNOTIFICATION_SOUND_ENABLED());
         ...
         case 1:
            ...
            Continuation $completion = (UserPreferencesRepository$special$$inlined$map$7$2$1)$continuation.L$1;
